...
| Data access             | PostgreSQL driver with ordered SQL migrations                                                   | The local Phase 1 API applies transactional, recorded migrations; an ORM can be added when it improves domain delivery without replacing database controls.                 |
